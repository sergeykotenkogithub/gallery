<div class="container">
    ...
    <div class="basket">
        ...
        <div class="basket__del">
            <a class="buy" href="/basket/?action=add&id=<?=$item['basket_id']?>&session=<?=$item['session_id']?>">+</a>
        </div>
        <div class="basket__del">
            <a class="buy" href="/basket/?action=deleteitem&quantity=<?=$item['quantity']?>&id=<?=$item['basket_id']?>&session=<?=$item['session_id']?>">-</a>
        </div>
    </div>
    <?php endforeach;?>
